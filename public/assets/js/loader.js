...
(function () {
  ...
  /**
   * Hand the page over - exactly once.
   *
   * This guard matters: a backgrounded tab throttles requestAnimationFrame,
   * so the failsafe could fire before the animation finished and the page
   * would be handed over twice. The name animation reads its target text
   * off the screen, so a second hand-over used to freeze mid-scramble
   * garbage as the visitor's name.
   */
